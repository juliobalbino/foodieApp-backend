...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.foodie.foodieApp.resources")).paths(PathSelectors.any())
				.build()
				.apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API do aplicativo FoodieApp",
				"Esta API é utilizada no aplicativo FoodieApp para estudos",
				"Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact("Julio Balbino", " ", "julio4110@gmail.com"),
